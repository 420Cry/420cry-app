...
export default function FearAndGreedGauge({
  ...
  const classificationKeyMap: Record<string, string> = {
    greed: 'indicator.fearAndGreed.greed',
    fear: 'indicator.fearAndGreed.fear',
    neutral: 'indicator.fearAndGreed.neutral',
    extremefear: 'indicator.fearAndGreed.extremeFear',
