...
export default function FearAndGreedIndexSkeleton(): JSX.Element {
    ...
    <div className="relative w-full max-w-sm mx-auto">
      ...
      <div className="bg-gray-950 rounded-lg shadow-2xl border border-gray-800 overflow-hidden">
        ...
        <div className="p-8 bg-gray-950">
          <div className="mx-auto w-full h-auto max-w-[280px]">
            {/* Skeleton SVG Gauge */}
            <svg
              viewBox="0 0 177 89"
              fill="none"
            ...
            >
              {/* Skeleton arcs with shimmer effect */}
              <path
        ...
        <div className="bg-gray-900 px-6 py-3 border-t border-gray-700">
          <div className="flex items-center justify-center gap-2 text-xs text-gray-400">
            ...
            <span>{t('indicator.fearAndGreed.loading')}</span>
          </div>
        </div>
      </div>
    </div>
