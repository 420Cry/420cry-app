...
export default function FeaturesSection(): JSX.Element {
  ...
  const features = [
    ...
    },
    {
      ...
      features: [
        t('landing.features.items.blockchainExplorer.features.transactionSearch'),
    ...
    },
    {
      ...
      features: [
        t('landing.features.items.portfolioTracking.features.portfolioOverview'),
        t('landing.features.items.portfolioTracking.features.priceAlerts'),
        t('landing.features.items.portfolioTracking.features.performanceTracking'),
